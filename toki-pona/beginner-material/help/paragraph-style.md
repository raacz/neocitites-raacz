...
- **Flat** collapses all line breaks and removes all indentations, and uses punctuation to indicate the end of sentences. You have a choice between what should be used as punctuation. The **Interpunct** looks like a vertically-centered period, ``·``. The **CJK Final** is a small unfilled circle ``。︁``, named as such because of its use in Chinese, Japanese and Korean. 
